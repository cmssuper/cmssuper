...
export default {
    ...
    data() {
        return {
            ...
            toolbar: [
                ...
                "hr bullist numlist link image charmap preview anchor insertdatetime media table emoticons forecolor backcolor fullscreen", //pagebreak分页
            ],
            plugins: [
    ...
    watch: {
        value(val) {
            if (!this.hasChange && this.hasInit) {
                this.$nextTick(() => window.tinymce.get("editor").setContent(val || ""));
            }
        },
    },
    mounted() {
    ...
    methods: {
            ...
            window.tinymce.init({
                ...
                images_upload_handler: (blobInfo, succFun) => {
                    ...
                    this.$axios.post("?m=upload", formdata, { headers: { "Content-Type": "multipart/form-data;charset=UTF-8" } }).then(res => {
                        succFun(this.$baseHost + res.data.success.location);
                    });
                },
                init_instance_callback: editor => {
                    ...
                    editor.on("NodeChange Change KeyUp SetContent", () => {
                        this.hasChange = true;
                        var content = editor.getContent().replace(/\.\.\/uploads\//gi, "/uploads/");
        ...
        destroyTinymce() {
            const tinymce = window.tinymce.get("editor");
            if (this.fullscreen) {
